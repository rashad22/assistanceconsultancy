                ...
                <div class="container">
                    ...
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand visible-md visible-lg" href="/.">
                            <img src="{{asset('public/website/images/logo.png')}}" alt="Assistency Consultancy" title="Assistency Consultancy" />
                        </a>
                        <a class="navbar-brand visible-xs visible-sm" href="/.">
                            <img src="{{asset('public/website/images/logo_mobile.png')}}" alt="Assistency Consultancy" title="Assistency Consultancy" />
                        </a>
                    </div>
                    ...
                    <div class="collapse navbar-collapse" id="main_menu">
                        <div class="contact_info visible-sm visible-md visible-lg">
                            <ul>
                                <li><a href="tel:1-773-744-7792"> <i class="fa fa-mobile"></i>1-773-744-7792</a></li>
                            </ul>
                        </div>
        ...
        <footer class="footer">
                    ...
                    <div class="col-xs-12 col-md-5 col-lg-4">
                        <div class="item find_us">
                            ...
                            <address>
                                <dl class="info">
                                    <dt>Office</dt>
                                    <dd><a href="">6352 N Fairfield Ave, Chicago, IL 60659</a></dd>
                                </dl>
                                <dl class="info">
                                    <dt>Phone</dt>
                                    <dd><a href="callto:1-312-823-7885">1-312-823-7885, 1-773-744-7792,<br /> 1-773-751-9717</a></dd>
                                </dl>
                                <dl class="info">
                                    <dt>E-mail</dt>
                                    <dd><a href="mailto:admin@assistanceConsultancy.com">admin@assistanceConsultancy.com</a></dd>
                                </dl>
                                <dl class="info">
                                    <dt>Website</dt>
            ...
            <div class="footer_last">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="copy_text">&copy; 2016 Assistance & Consultancy BD LLC.</div>
                        </div>
                    </div>
                </div>
            </div>
